package javafx_udp_chat_server.application;
...
import javafx_udp_chat_server.thread.ChatServerRunnable;
import javafx_udp_chat_server.vo.ClientVO;

public class MainController implements Initializable{

	//접속한 클라이언트의 ip주소를 표시해 줄 리스트뷰
	@FXML private ListView<String> listView_client;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		listView_client.setItems(clientList);
