...
public class U_BarChartTest extends Application{
	@Override
	public void start(Stage primaryStage) throws Exception {
		...
		ser2List.addAll(new XYChart.Data<>("호주", 50000), new XYChart.Data<>("브라질", 41000),
				new XYChart.Data<>("프랑스", 45000), new XYChart.Data<>("이탈리아", 11700),
		...
		ser3.setName("2017년");
		ser3.getData().add(new XYChart.Data<String, Number>("호주", 45000));
		ser3.getData().add(new XYChart.Data<String, Number>("브라질", 44000));
		ser3.getData().add(new XYChart.Data<String, Number>("프랑스", 18000));
		ser3.getData().add(new XYChart.Data<String, Number>("이탈리아", 17000));
		ser3.getData().add(new XYChart.Data<String, Number>("미국", 23000));
