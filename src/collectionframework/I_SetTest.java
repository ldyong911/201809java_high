...
public class I_SetTest {
	public static void main(String[] args) {
		...
		for(char ch='Z'; ch>='A'; ch--) {
			...
			ts.add(temp); // TreeSet은 add할때 순서가 자동으로 정렬됨
		}
		...
		System.out.println("K 이후 자료(기준값 포함): " + ts.tailSet("K", true)); // 기준값 포함
		...
		System.out.println("K(true) ~ N(true): " + ts.subSet("K", true, "N", true));
		System.out.println("K(false) ~ N(false): " + ts.subSet("K", false, "N", false));
		System.out.println("K(false) ~ N(true): " + ts.subSet("K", false, "N", true));
